...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "bHVpcy5nb21lekBwb3Ryb3MuaXRzb24uZWR1Lm14";
        const char* EMAILBASE64_PASSWORD = "MTI5NTJHb20=";
        const char* FROM = "luis.gomez@potros.itson.edu.mx";
